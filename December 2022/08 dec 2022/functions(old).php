...
//Promotion strip Carousel
	...
	// });
			...
			$(document).on("click",".web-btn",function() {
				$('ul li.buynow a').click();
			});
		...
		<div class="section">
			<div class="container">
				...
				<div class="left">
					...
					<h3>Welcome, '.$current_user->user_firstname.'!</h3>
					<h4 class="user_desc">Lorem ipsum dolor sit amet consectetur adipisicing elit.</h4>
				</div>
				<div class="right">
					<img src="'.$user_image.'" class="user_profile_image">
				</div>
			</div>
		</div>
		';
